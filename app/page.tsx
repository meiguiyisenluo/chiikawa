...
export default async function Page(props: {
...
}) {
  {
    ...
    const fileList = await fetch(url + slug.join("/")).then((res) =>
      res.json()
    );

    return (
      <div className="w-full h-[93%] sm:h-[95%] flex flex-wrap content-start justify-start overflow-y-auto overflow-x-hidden">
